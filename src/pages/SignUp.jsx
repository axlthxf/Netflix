                    ...
                    <div class="w-full  backdrop-filter backdrop-blur-sm bg-opacity-40 bg-neutral-700 rounded-lg shadow dark:border md:mt-0 sm:min-w-xl xl:p-0 shadow shadow-lg shadow-red-600/50 dark:bg-gray-800 dark:border-gray-700">
                        <div class="p-6  space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6 flex flex-col items-center" action="#">
                                ...
                                <button type="submit" class=" border w-[50%]  bg-red-600 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign Up</button>
                            </form>
                        </div>
                    </div>
                </div>
